...
import { Mail, Lock, Loader2, ArrowLeft, Eye, EyeOff, Home, ArrowRight } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen flex bg-white font-sans">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                <img
                    src="https://images.unsplash.com/photo-1510798831971-661eb04b3739?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                    alt="Cozy Stay"
                ...
                <div className="relative z-10 flex flex-col justify-between p-12 w-full">
                    ...
                    <div className="space-y-6 max-w-lg">
                        ...
                        <p className="text-xl text-rose-100/90 font-medium leading-relaxed">
                            Log in to discover unique farmhouses, manage your bookings, and experience unforgettable stays.
                        </p>
                    </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 lg:p-16 bg-white overflow-y-auto relative">
                ...
                <div className="w-full max-w-[420px] py-10">
                    <div className="space-y-2 mb-10 text-center lg:text-left">
                        <h2 className="text-4xl font-extrabold text-[#1a1a1a] tracking-tight">Welcome Back</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        type="email"
                                        required
                                        className="block w-full pl-12 pr-4 py-4 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-600 transition-all duration-200 sm:text-sm font-medium shadow-sm"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        required
                                        className="block w-full pl-12 pr-12 py-4 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-600 transition-all duration-200 sm:text-sm font-medium shadow-sm"
                                        placeholder="••••••••"
                                        value={password}
                                        onChange={handleChange}
                                    />
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-700 hover:to-pink-700 text-white font-bold py-4 px-4 rounded-xl shadow-lg shadow-rose-500/20 transition-all duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.01] active:scale-[0.99] mt-2"
                            >
                                {loading ? (
