...
import { Mail, Lock, User, Loader2, ArrowLeft, Eye, EyeOff, Home, ArrowRight } from 'lucide-react';
...
const Register = () => {
    ...
    const googleLogin = useGoogleLogin({
        onSuccess: async (tokenResponse) => {
            try {
                const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/users/google-auth`, {
    ...
    return (
        <div className="min-h-screen flex bg-white font-sans">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                <img
                    src="https://images.unsplash.com/photo-1582719508461-905c673771fd?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                    alt="Luxury Villa"
                ...
                <div className="relative z-10 flex flex-col justify-between p-12 w-full">
                    ...
                    <div className="space-y-6 max-w-lg">
                        ...
                        <p className="text-xl text-rose-100/90 font-medium leading-relaxed">
                            Join thousands of travelers who trust UtsavNest for their unique stays and memorable experiences.
                        </p>
                    </div>

                    <div className="text-rose-200/60 text-sm font-medium">
                        © 2026 UtsavNest. All rights reserved.
                    </div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 lg:p-14 bg-white overflow-y-auto relative">
                <Link to="/" className="absolute top-8 left-8 flex items-center text-gray-500 hover:text-rose-600 transition-colors font-bold text-sm bg-gray-50 px-4 py-2 rounded-lg border border-gray-100 shadow-sm">
                ...
                <div className="w-full max-w-[440px] py-10">
                    <div className="space-y-2 mb-8 text-center lg:text-left">
                        <h2 className="text-4xl font-extrabold text-[#1a1a1a] tracking-tight">Create Account</h2>
                        <p className="text-gray-500 font-medium">Sign up for free and start exploring.</p>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="relative py-2">
                            ...
                            <div className="relative flex justify-center text-[10px] uppercase tracking-[0.2em] font-black">
                                <span className="px-6 bg-white text-gray-300">Or email registration</span>
                            </div>
                        </div>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        required
                                        className="block w-full pl-12 pr-4 py-3.5 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-600 transition-all duration-200 sm:text-sm font-medium shadow-sm"
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="block w-full pl-11 pr-10 py-3.5 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-600 transition-all duration-200 sm:text-sm font-medium shadow-sm"
                                            placeholder="••••••••"
                                            value={password}
                                            onChange={handleChange}
                                        />
