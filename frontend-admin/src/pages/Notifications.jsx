...
import { Bell, Check, CheckCheck, X, Trash2, Loader2, Users, Store, Settings, ShieldAlert, CreditCard, Calendar } from 'lucide-react';
...
const Notifications = () => {
    ...
    // Use notifications from context if available, otherwise local state logic could be redundant
    // But let's keep local state sync in case we want independent filtering
    ...
    const handleNotificationClick = (notification) => {
        ...
        if (notification.data?.vendorId) {
            navigate(`/vendors/${notification.data.vendorId}`);
        } else if (notification.data?.userId) {
            navigate(`/users/${notification.data.userId}`);
    ...
    const getNotificationIcon = (type) => {
        ...
        switch (type) {
            ...
            case 'payout_requested':
                return <CreditCard className={`${iconClass} text-amber-600`} />;
            case 'system_alert':
        ...
        <div className="max-w-5xl mx-auto py-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Manage platform alerts and updates</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
                    ...
                    {notificationPermission !== 'granted' && (
                        <button
                            ...
                            className="ml-auto text-xs font-semibold bg-primary-600 text-white px-3 py-2 rounded-lg hover:bg-primary-700 transition"
                        >
                            Enable
                        </button>
                    )}
